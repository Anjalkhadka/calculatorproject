...
root = Tk()
root.title("Calculator")       # name the app, i choose a "Calculator" because it's random
operator = ""
...
def btnEqualsInput():     #define the Equal to function
    global operator
    sumup=str(eval(operator)) #eval is a function in the python which convert any kind of mathmetical data in appropriate fromat
...
doublezero=Button(root,padx=16,pady=16,bd=8, fg="black",font=('arial', 20,'bold'),
            text="00",bg="powder blue",).grid(row=1,column="1")

Btnbraket1=Button(root,padx=16,pady=16,bd=8, fg="black",font=('arial', 20,'bold'),
            text="(",bg="powder blue",command=lambda:btnclick("(")).grid(row=1,column="2")

Btnbracket2=Button(root,padx=16,pady=16,bd=8, fg="black",font=('arial', 20,'bold'),
...
Dot=Button(root,padx=16,pady=16,bd=8, fg="black",font=('arial', 20,'bold'),
